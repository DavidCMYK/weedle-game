...
function create ()
{
    ...
    player = this.physics.add.sprite(20, 7*65-40, 'weedle');
...
function suddenDeath (player, enemy)
{
    ...
    getElementById('name_field').value = 'first';
    if ((getElementById('name_field').value != '') && (getElementById('email_field').value != ''))
    {
        getElementById('name_field').value = 'second';
    }

}

function submitAndRestart(pointer) {
    document.getElementById('name_field').value = 'testing';
}
